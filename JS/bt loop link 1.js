...
function reverse(n){
    ...
    while (n > 0){
        const digit = n % 10; // lay so cuoi, %10 -> 0
        x = x * 10 + digit;  //x * 10 + vao x^10
        n =  Math.floor(n / 10); //chia 10 khong lay du
    }
    return x;
}
...
// Số hoàn hảo là số có tổng ước số của nó (không tính nó) bằng chính nó. Ví dụ như Số 28 là số hoàn hảo vì ước chung lớn nhất của 28 (không tính số 28) gồm: 1; 2; 4; 7; 14. mà 1+2+4+7+14=28. 
